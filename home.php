    ...
    <body>
        ...
        <div id="container">	
			...
			<div style= 'margin-left: 150px; margin-top: 3em;'>
					<table>
						<tr><td><h2>STATIONS </h2></td><td><noscript>&nbspSorry, but Javascript is required -> website may not work properly</noscript></td></tr>
					</table>
				<div>
					<?php include('showRoutes.php'); ?>
				</div>				
			</div>
		</div>
		<footer>
			<img src='images/busReverse.png' id= 'logo'>&nbspExam of Distribuited Programming I, Politecnico di Torino 03/07/2018, Valerio Paolicelli 253054
		</footer>
	</body>
</html>